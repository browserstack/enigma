...
@pytest.mark.parametrize(
    ...
    [
        ...
        # (Test_pendingFailure_Exception, "{'error': {'error_msg': 'GetUserFailureException',
        # 'msg': 'Error in request not found OR Invalid request type'}}",
        # ["Failure1"], "GetUserFailureException"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # (test_pendingRevoke_Exception, "{'error': {'error_msg': 'getUserExceptionString',
        # 'msg': 'Error in request not found OR Invalid request type'}}",
