...
urlpatterns = [
    ...
    path("access/markRevoked", mark_revoked, name="markRevoked"),
    ...
    path("access/userManagement", user_management, name="userManagement"),
    path("user/offboardUser", user_offboarding, name="offboarding_user"),
    path("access/requestAccess", request_access, name="requestAccess"),
    path("group/requestAccess", group_access, name="groupRequestAccess"),
